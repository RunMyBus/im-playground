import Greenindiachallenge from "./component";
import { formatTitle } from "@/app/utils/titleValidator";

export async function generateMetadata() {
  const apiRoute = process.env.API_ROUTE; //api base url
  //fetching metadata for grreen india challenge page
  var myHeaders = new Headers();
  myHeaders.append("Content-Type", "application/json");
  var raw = JSON.stringify({ type: "greenIndiaChallenge" });
  var requestOptions = {
    method: "POST",
    headers: myHeaders,
    body: raw,
